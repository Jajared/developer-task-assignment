...
/**
 * Builds the Express app without binding a port: middleware, /health, the
 * service routers, the JSON 404 and the error handler. `index.ts` listens on
 * it; tests call `app.listen(0)` for a throwaway port.
 */
